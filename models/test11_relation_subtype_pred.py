...
def main():
    ...
    input_file0 = './test_relation/test1_triggers_relation.txt' #trigger
    ...
    df_med.to_csv('./template_rl/subtype_test11_med.csv', header = False) # relative position
    df_emp.to_csv('./template_rl/subtype_test11_emp.csv', header = False) # relative position
    df_liv_Status.to_csv('./template_rl/subtype_test11_liv_status.csv', header = False) # relative position
    df_liv_Type.to_csv('./template_rl/subtype_test11_liv_type.csv', header = False) # relative position
