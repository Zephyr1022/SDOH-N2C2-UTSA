...
def main():
    ...
    spaceline_tag("sdoh_shuffle.conll",'tag_'+para_data['argument_file']+'_dev.conll')
    del_num('tag_'+para_data['argument_file']+'_dev.conll', 'dev_'+para_data['argument_file'] +'_ner.txt')
