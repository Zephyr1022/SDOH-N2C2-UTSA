...
def main():
    ...
    df_med.to_csv('./template_rl/subtype_test12_med.csv', header = False) # relative position
    df_emp.to_csv('./template_rl/subtype_test12_emp.csv', header = False) # relative position
    df_liv_Status.to_csv('./template_rl/subtype_test12_liv_status.csv', header = False) # relative position
    df_liv_Type.to_csv('./template_rl/subtype_test12_liv_type.csv', header = False) # relative position
