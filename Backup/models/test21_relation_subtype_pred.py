...
def main():
    ...
    df_med.to_csv('./template_rl/subtype_test21_med.csv', header = False) # relative position
    df_emp.to_csv('./template_rl/subtype_test21_emp.csv', header = False) # relative position
    df_liv_Status.to_csv('./template_rl/subtype_test21_liv_status.csv', header = False) # relative position
    df_liv_Type.to_csv('./template_rl/subtype_test21_liv_type.csv', header = False) # relative position
