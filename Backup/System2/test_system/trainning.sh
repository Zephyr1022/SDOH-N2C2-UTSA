...
CUDA_VISIBLE_DEVICES=1 nohup python sdoh_trainer2.py sdoh-26-trigger-tag-piece.yaml train_triggers_tag_ner.txt dev_triggers_tag_ner.txt > ./ner_results/trigger_tag_ner_piece.out 2>&1 &
