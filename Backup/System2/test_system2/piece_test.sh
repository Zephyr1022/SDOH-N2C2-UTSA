#!/bin/bash
# 2796.ann
E1	LivingStatus:T1 Status:T3 Type:T2
E6	LivingStatus:T17 Status:T19 Type:T18
T1	LivingStatus 16 24	Homeless
T2	TypeLiving 16 24	Homeless
T3	StatusTime 16 24	Homeless
T17	LivingStatus 315 323	homeless
T18	TypeLiving 315 323	homeless
T19	StatusTime 315 323	homeless
A1	TypeLivingVal T2 homeless
A2	StatusTimeVal T3 current
A8	TypeLivingVal T18 homeless
A9	StatusTimeVal T19 current

# generate all groundtruth ann for trigger
python event_trigger_piece.py

# test2_triggers_relation.txt
# /ANNTABLE/system5/ann
