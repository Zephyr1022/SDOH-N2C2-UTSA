...
CUDA_VISIBLE_DEVICES=0 nohup python sdoh_trainer2.py sdoh-26-trigger-uw_train_dev.yaml train_trigger_uw_ner.txt dev_trigger_uw_ner.txt > ./ner_results/trigger_ner_uw_train_dev.out 2>&1 &
...
CUDA_VISIBLE_DEVICES=0 nohup python sdoh_trainer2.py sdoh-26-arg-together-uw.yaml train_arg_together_uw_ner.txt dev_arg_together_uw_ner.txt  > ./ner_results/arg_together_ner_uw_train_dev.out 2>&1 &
...
CUDA_VISIBLE_DEVICES=2 nohup python sdoh_trainer2.py sdoh-26-drug-uw_train_dev.yaml train_argu_drug_uw_ner.txt dev_argu_drug_uw_ner.txt > ./ner_results/drug_ner_uw_train_dev.out 2>&1 &

# Alcohol
# EPOCH 9 done: loss 0.0094 - lr 0.1000000; DEV : loss 0.008061129599809647 - f1-score (micro avg)  0.7855

CUDA_VISIBLE_DEVICES=3 nohup python sdoh_trainer2.py sdoh-26-alcohol-uw_train_dev.yaml train_argu_alcohol_uw_ner.txt dev_argu_alcohol_uw_ner.txt > ./ner_results/alcohol_ner_uw_train_dev.out 2>&1 &

# Tobacco
# EPOCH 16 done: loss 0.0052 - lr 0.0500000; DEV : loss 0.01181077491492033 - f1-score (micro avg)  0.8187

CUDA_VISIBLE_DEVICES=1 nohup python sdoh_trainer2.py sdoh-26-tobacco-uw_train_dev.yaml train_argu_tobacco_uw_ner.txt dev_argu_tobacco_uw_ner.txt  > ./ner_results/tobacco_ner_uw_train_dev.out 2>&1 &

# Livingstatue
# EPOCH 14 done: loss 0.0053 - lr 0.0250000; DEV : loss 0.028041338548064232 - f1-score (micro avg)  0.8296

CUDA_VISIBLE_DEVICES=2 nohup python sdoh_trainer2.py sdoh-26-livingstatus-uw_train_dev.yaml train_argu_liv_uw_ner.txt dev_argu_liv_uw_ner.txt > ./ner_results/liv_ner_uw_train_dev.out 2>&1 &

# Employment
# EPOCH 12 done: loss 0.0050 - lr 0.0500000; DEV : loss 0.022013071924448013 - f1-score (micro avg)  0.7079

CUDA_VISIBLE_DEVICES=3 nohup python sdoh_trainer2.py sdoh-26-employment-uw_train_dev.yaml train_argu_emp_uw_ner.txt dev_argu_emp_uw_ner.txt > ./ner_results/emp_ner_uw_train_dev.out 2>&1 &
...
nohup python relation_pcl.py './template_rl/relation_train.csv' './template_rl/relation_dev.csv' './model_save/distilbert-model-match-baseline-nlp-lr-v2-uw.pt' 'cuda:1' > ./relation_results/train_relation_uw.out 2>&1 & 
